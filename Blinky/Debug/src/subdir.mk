...
src/%.o: ../src/%.c src/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: MCU C Compiler'
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -D__USE_CMSIS=CMSIS_CORE_LPC8xx -D__LPC8XX__ -I"/Users/tedd/dev/mcuxpresso/__lpc810/lpc800_driver_lib" -I"/Users/tedd/dev/mcuxpresso/__lpc810/CMSIS_CORE_LPC8xx" -I"/Users/tedd/dev/mcuxpresso/__lpc810/CMSIS_CORE_LPC8xx/inc" -I"/Users/tedd/dev/mcuxpresso/__lpc810/lpc800_driver_lib/inc" -O0 -g3 -gdwarf-4 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m0 -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
clean-src:
	-$(RM) ./src/cr_startup_lpc8xx.d ./src/cr_startup_lpc8xx.o ./src/crp.d ./src/crp.o ./src/main.d ./src/main.o
